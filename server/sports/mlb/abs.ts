...
//     → good framers (positive FRS) gave the pitcher extra called strikes.
//       Under ABS that edge evaporates. Bad framers (negative FRS) never
//       provided an edge, so penalty floors at 0.
//   penalty = absExposurePct × lostRunsPerGame × 9 / IP_per_start_avg
